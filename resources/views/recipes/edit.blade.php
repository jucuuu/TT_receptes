<x-layout>
    <div>
        <a href="/recipes/{{$recipe->id}}" class="inline-block border-2 border-white text-white py-2 px-4 rounded-xl mt-2 hover:text-black hover:border-black bg-sky-500 hover:bg-sky-600">Back</a>
    </div>
